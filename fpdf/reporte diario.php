<?php
	...
	$mes = date("m"); 
	$dia = date("d")-1; 
	$query = "select(ingresos.fecha) as Ingreso,ingresos.fechasalida as Salida, (ingresos.tiempo) as  Hora_Entrada,ingresos.horasalida as Hora_salida, ingresos.Placas, ingresos.Lugar,vehiculos.NombreCliente,vehiculos.Marca,(vehiculos.TipoV) as Tipo from ingresos left join vehiculos on ingresos.Placas = vehiculos.Placas where day(fecha) = '$dia' ORDER BY ingresos.fecha ";
	...
	{
	$pdf->Cell(80,8,'Reporte del dia: '.utf8_decode($row['Ingreso']),0,1,'C');
