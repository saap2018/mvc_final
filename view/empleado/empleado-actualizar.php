...
<h1 class="page-header">
    <?php echo $alm->IdEmpleado != null ? $alm->Nombre : 'Editar empleado'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="?c=Empleado">Empleados</a></li>
  <li class="active"><?php echo $alm->IdEmpleado != null ? $alm->Nombre : 'Editar empleado'; ?></li>
</ol>
<form id="frm-alumno" action="?c=Empleado&a=Modificar" method="post" enctype="multipart/form-data" onsubmit="https://www.w3resource.com/html-css-exercise/basic/solution/select-required-answer-demo.php">
    <input type="hidden" name="IdEmpleado" value="<?php echo $alm->IdEmpleado; ?>" />
    
    <div class="form-group">
        <label>Tipo de Documento</label> 
        <label for="select"></label>
        <select required aria-required="true" name="TipoDeDocumento" id="select" class="form-control" required="required">
        <option required value="<?php echo $alm->TipoDeDocumento; ?>"><?php echo $alm->TipoDeDocumento; ?> </option>
          <?php
do {  
?>
...
?>
    ...
    <div class="form-group">
      ...
      <label for="select2" ></label>
        <select required aria-required="true" name="Cargo" id="select2" class="form-control">
        <option required value="<?php echo $alm->Cargo; ?>"><?php echo $alm->Cargo; ?> </option>
          <?php
do {  
?>
