...
<form id="frm-usuario" action="?c=TipoVehiculo&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nombre_tipov" value="<?php echo $alm->nombre_tipov; ?>" class="form-control" placeholder="Nombre del tipo de vehículo" onkeypress="return soloLetras(event)" required />
    </div>
    <hr />
