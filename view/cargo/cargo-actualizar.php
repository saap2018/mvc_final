...
<form id="frm-usuario" action="?c=Cargo&a=Modificar" method="post" enctype="multipart/form-data">
    <input type="hidden" name="id_cargo" value="<?php echo $alm->id_cargo; ?>" />
    <div class="form-group">
        <label>Nombre del cargo</label>
        <input type="text" name="nombre_cargo" value="<?php echo $alm->nombre_cargo; ?>" class="form-control" placeholder="Nombre del cargo" required />
    </div> 
    <hr />
