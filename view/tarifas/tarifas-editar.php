...
<form id="frm-usuario" action="?c=Tarifas&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="tarifa" value="<?php echo $alm->tarifa; ?>" class="form-control" placeholder="Nuevo tipo de tarifa" onkeypress="return soloLetras(event)" required />
    </div>
    <div class="form-group">
        <label>Valor</label>
        <input type="text" name="valor" value="<?php echo $alm->valor; ?>" class="form-control" placeholder="Valor de tarifa" onkeypress="return soloNumeros(event)" required />
    </div>
    <hr />
