...
<h1 class="page-header">
    <?php echo $alm->id != null ? $alm->nombre : 'Modificar Registro'; ?>
</h1>

<ol class="breadcrumb">
 <li><a href="?c=Usuarioadmin">Usuarios</a></li>
  <li class="active"><?php echo $alm->id != null ? $alm->nombre : 'Modificar Registro'; ?></li>
</ol>

<form id="frm-usuario" onclick="return checkform(this)" action="?c=Usuarioadmin&a=Modificar" method="post" enctype="multipart/form-data">
  ...
  var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toLowerCase(); this.setSelectionRange(start, end);" required />
    ...
    <div class="form-group">
        ...
        <input type="text" name="contrasena" value="<?php echo base64_decode($alm->contrasena); ?>" class="form-control" placeholder="Contraseña para el usuario actuál" data-validacion-tipo="requerido|min:6" required />
    </div> 
     <div class="form-group">
