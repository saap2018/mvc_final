...
<form id="frm-usuario" onclick="return checkform(this)" action="?c=Usuario&a=Modificar" method="post" enctype="multipart/form-data">
  ...
  var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toLowerCase(); this.setSelectionRange(start, end);" required />
    ...
    <div class="form-group">
        ...
        <input type="text" name="contrasena" value="<?php echo base64_decode($alm->contrasena); ?>" class="form-control" placeholder="Ingrese su contraseña" data-validacion-tipo="requerido|min:6" required />
    </div> 
    <div class="form-group">
